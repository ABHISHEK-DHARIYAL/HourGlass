// Purpose: Full-screen ambient clock view showing current time, date, progress through the day, and toggleable 24-hour format
  ...
  return (
    <div className="min-h-screen bg-ledger-dark text-ledger-paper p-6 flex flex-col justify-between select-none">
      ...
      <div className="w-full max-w-[430px] mx-auto flex items-center justify-between pb-4 border-b border-ledger-line/30">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="px-2.5 py-1 surface-panel rounded-lg text-[11px] font-mono text-ledger-paper-dim hover:text-ledger-coral hover:border-ledger-coral cursor-pointer transition-all"
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1 surface-panel rounded-lg text-[11px] font-mono text-ledger-paper-dim hover:text-ledger-coral hover:border-ledger-coral cursor-pointer transition-all"
      ...
      <div className="flex-1 flex flex-col justify-center items-center py-12">
        {showAnalog ? (
          <div className="relative w-64 h-64 rounded-full border-2 border-ledger-line bg-ledger-slate flex items-center justify-center"
        ...
        <div className="mt-8 text-center">
          <p className="text-base text-ledger-coral font-semibold leading-relaxed">
            {formatDateString()}
          </p>
          <p className="font-mono text-[10px] text-ledger-paper-dim/70 uppercase tracking-widest mt-1.5">
      ...
      {/* Footer Branding */}
      <div className="w-full text-center pb-2 text-[10px] text-ledger-paper-dim/50 font-mono">
