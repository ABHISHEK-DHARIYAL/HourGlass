// Purpose: Date formatting, parsing, recurrence computation, task segment calculation, and streak tracking helper functions
/**
 * @license
...
/**
 * Returns human-readable label for a task's recurrence setting
 */
